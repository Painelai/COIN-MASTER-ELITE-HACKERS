          ...
          <div className="p-4 sm:p-6 md:p-8 overflow-y-auto scrollbar-none relative">
            ...
            <div className="flex flex-col md:flex-row gap-6 items-stretch">
              ...
              <div className="w-full md:w-[52%] flex flex-col justify-center">
                ...
                <button 
                  onClick={handleClaim}
                  className="w-full bg-gradient-to-r from-emerald-600 to-green-500 hover:from-green-500 hover:to-emerald-400 text-white font-display font-black py-5 rounded-xl shadow-[0_10px_30px_rgba(16,185,129,0.3)] active:scale-95 transition-all flex items-center justify-center gap-3 group relative overflow-hidden"
                >
                  <Unlock className="w-6 h-6" />
                  <span className="text-base uppercase tracking-widest">PEGAR PRESENTE AGORA</span>
